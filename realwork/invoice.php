  ...
  { 
    ...
    $statement= $connect->prepare("
      INSERT INTO tbl_order 
        (order_id, order_no, order_date, order_receiver_name, order_receiver_address, order_total_before_tax, order_total_tax1, order_total_tax2, order_total_tax3, order_total_tax, order_total_after_tax, order_datetime)
        VALUES (NULL ,:order_no, :order_date, :order_receiver_name, :order_receiver_address, :order_total_before_tax, :order_total_tax1, :order_total_tax2, :order_total_tax3, :order_total_tax, :order_total_after_tax, :order_datetime)
    ");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
            ...
            <tr>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="update_invoice" id="create_invoice" class="btn btn-info" value="Save" />
                </td>
              </tr>
          </table>
        </div>
      ...
      {
      ?>
      <h3 align="center">Zarzis Invoice</h3>
      ...
      <table id="data-table" class="table table-bordered table-striped">
        <thead>
          <tr>
            <th>Invoice No.<i class="fas fa-edit"></i></th>
            <th>Invoice Date</th>
            <th>Receiver Name</th>
            <th>Invoice Total</th>
            <th>PDF</th>
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="../invoicr-master/example/index.php?id='.$row["order_id"].'">PDF</a></td>
                <td><a href="invoice.php?update=1&id='.$row["order_id"].'">Edit</a></td>
                <td><a href="#" id="'.$row["order_id"].'" class="delete">Delete</a></td>
              </tr>
            ';
          }
        }
